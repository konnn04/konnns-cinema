...
import { Home, Search, History, Heart, Settings } from 'lucide-react';
...
export default function MobileNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 bg-zinc-950/95 backdrop-blur-md border-t border-zinc-900 px-4 py-2 flex items-center justify-around md:hidden safe-area-bottom pb-4 shadow-[0_-10px_20px_rgba(0,0,0,0.5)]">
      {navItems.map((item) => {
